...
export default function OurMembership() {
  ...
  return (
    <section
      className="bg-[F0F0F0]  pt-[9.75rem] pb-[9.75rem] 
    max-[991px]:pt-[4rem] 
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 lg:gap-6">
          {/* first card */}
          <div
            className="
    ...
    md:flex md:items-center md:justify-between md:gap-[1.25rem] 
    md:p-[2.5rem_1.875rem] 
    sm:flex-col sm:rounded-[0.5rem]
  "
          >
      ...
      md:text-[1.25rem] sm:text-[1.5rem] sm:text-center 
      text-gray-900 mb-4
    "
              >
                Flat monthly fee
    ...
    "
          ...
          <div className="flex flex-row">
            ...
            {/* two */}
            <div className="relative h-[250px] mt-8 overflow-hidden rounded-2xl">
              <video
  ...
  "
    ...
    rounded-lg  
    p-[2.5rem_2rem] 
    md:flex md:justify-between md:gap-[1.25rem] 
    md:p-[2.5rem] 
    sm:flex-col sm:px-[1.5rem] sm:rounded-[0.5rem]
    md:col-span-2
  "
          >
            <div className="relative z-10">
